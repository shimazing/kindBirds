"""Modification of https://github.com/carpedm20/deep-rl-tensorflow/blob/master/networks/cnn.py"""
import os
    ...
    if inputs is None:
        if data_format == 'NHWC':
          self.inputs = tf.placeholder('float32',
              [None] + observation_dims, name='inputs')# + [history_length], name='inputs')
        elif data_format == 'NCHW':
          self.inputs = tf.placeholder('float32',
              [None] + observation_dims, name='inputs')
